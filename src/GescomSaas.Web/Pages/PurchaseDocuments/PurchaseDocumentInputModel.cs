...
public class PurchaseDocumentInputModel
{
    [Display(Name = "Type de piece")]
    public CommercialDocumentType DocumentType { get; set; } = CommercialDocumentType.PurchaseRequest;
    ...
    public static PurchaseDocumentInputModel FromEntity(CommercialDocument entity) =>
        new()
        {
